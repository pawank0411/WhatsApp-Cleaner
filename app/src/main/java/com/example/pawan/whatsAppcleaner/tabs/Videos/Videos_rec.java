package com.example.pawan.whatsAppcleaner.tabs.Videos;
...
public class Videos_rec extends AppCompatActivity implements InnerDetailsAdapter_video.OnCheckboxListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (success == 0) {
                    Toast.makeText(Videos_rec.this, "Couldn't delete some files", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Videos_rec.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                }
...
//        }
    ...
    public void onCheckboxClicked(View view, List<FileDetails> pos) {
        ...
        if (filesToDelete.size() > 0) {
            ...
            String size = Formatter.formatShortFileSize(Videos_rec.this, totalFileSize);
