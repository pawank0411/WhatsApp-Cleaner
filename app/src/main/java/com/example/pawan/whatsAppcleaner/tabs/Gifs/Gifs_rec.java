...
public class Gifs_rec extends AppCompatActivity implements InnerDetailsAdapter_video.OnCheckboxListener {

    //List<Details>  innerdatalist;
    RecyclerView recyclerView;
    Button button;
    InnerDetailsAdapter_video innerDetailsAdapterVideo;
...
//    private int [] Pos=new int[149];
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (success == 0) {
                    ...
                    Toast.makeText(Gifs_rec.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                }
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            String path = Environment.getExternalStorageDirectory().toString() + "/WhatsApp/Media/WhatsApp Animated Gifs";
...
//        }
        ...
        innerDetailsAdapterVideo = new InnerDetailsAdapter_video(this, innerdatalist, this);
    ...
    public void onCheckboxClicked(View view, List<FileDetails> pos) {
        ...
        if (filesToDelete.size() > 0) {
            ...
            String size = Formatter.formatShortFileSize(Gifs_rec.this, totalFileSize);
