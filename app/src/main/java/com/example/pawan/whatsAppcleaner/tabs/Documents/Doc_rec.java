    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (success == 0) {
                    Toast.makeText(Doc_rec.this, "Couldn't delete some files", Toast.LENGTH_SHORT).show();
                } else if (success == 1){
                    Toast.makeText(Doc_rec.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                }
...
//        }
    ...
    public void onCheckboxClicked(View view, List<FileDetails> pos) {
        ...
        if (filesToDelete.size() > 0) {
            ...
            String size = Formatter.formatShortFileSize(Doc_rec.this, totalFileSize);
