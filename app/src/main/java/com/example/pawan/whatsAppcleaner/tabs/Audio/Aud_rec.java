...
public class Aud_rec extends AppCompatActivity implements InnerDetailsAdapter_audio.OnCheckboxListener {
    ...
    InnerDetailsAdapter_audio innerDetailsAdapter_audio;
...
//    private int [] Pos=new int[149];
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (success == 0) {
                    Toast.makeText(Aud_rec.this, "Couldn't delete some files", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Aud_rec.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                }
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            String path = Environment.getExternalStorageDirectory().toString() + "/WhatsApp/Media/WhatsApp Audio";
            ...
            if (results != null) {
                ...
                Toast.makeText(this, "No Files Found in "+directory.getName(), Toast.LENGTH_SHORT).show();
                Log.e("Files", "No files found in " + directory.getName());
            }
        }

        innerDetailsAdapter_audio = new InnerDetailsAdapter_audio(this, innerdatalist, this);
        recyclerView.setAdapter(innerDetailsAdapter_audio);
    }
    ...
    public void onCheckboxClicked(View view, List<FileDetails> pos) {
        ...
        if (filesToDelete.size() > 0) {
            ...
            String size = Formatter.formatShortFileSize(Aud_rec.this, totalFileSize);
