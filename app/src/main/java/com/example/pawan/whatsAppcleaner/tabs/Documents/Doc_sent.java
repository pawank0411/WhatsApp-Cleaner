...
public class Doc_sent extends AppCompatActivity implements InnerDetailsAdapter_doc.OnCheckboxListener {
...
//    private int [] Pos=new int[149];
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
           //Need to ask permission again or close the app
            ...
            String path = Environment.getExternalStorageDirectory().toString() + "/WhatsApp/Media/WhatsApp Documents/Sent";
    ...
    public void onCheckboxClicked(View view, List<FileDetails> pos) {
        ...
        if (filesToDelete.size() > 0) {
            ...
            String size = Formatter.formatShortFileSize(Doc_sent.this, totalFileSize);
