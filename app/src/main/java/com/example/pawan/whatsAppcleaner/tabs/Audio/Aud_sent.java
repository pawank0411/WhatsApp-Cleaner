...
public class Aud_sent extends AppCompatActivity implements InnerDetailsAdapter_audio.OnCheckboxListener {
...
//    private int [] Pos=new int[149];
    ...
    public void onCheckboxClicked(View view, List<FileDetails> pos) {
        ...
        if (filesToDelete.size() > 0) {
            ...
            String size = Formatter.formatShortFileSize(Aud_sent.this, totalFileSize);
