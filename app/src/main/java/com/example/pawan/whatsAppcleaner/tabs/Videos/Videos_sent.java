...
public class Videos_sent extends AppCompatActivity implements InnerDetailsAdapter_image.OnCheckboxListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (success == 0) {
                    Toast.makeText(Videos_sent.this, "Couldn't delete some files", Toast.LENGTH_SHORT).show();
                } else if (success == 1){
                    Toast.makeText(Videos_sent.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                }
